...
void main()
{
    vec3 color_1 = RGB(255, 71,  48 );
    vec3 color_2 = RGB(219, 113, 42 );
    vec3 color_3 = RGB(247, 241, 186);

    float gradient = noise(vec3(v_position.z + sin(time * 0.1) * 20.0, time, v_position.x + sin(time * 0.15) * 12.0));
